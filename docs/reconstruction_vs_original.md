...
[`results/original_paper/README.md`](../results/original_paper/README.md).
...
[`results/reconstruction_v2/`](../results/reconstruction_v2/).
...
run. See [`MT_Reconstruction_Audit.md`](MT_Reconstruction_Audit.md).
...
- [`results/README.md`](../results/README.md) — the archival layer and source-path mapping
- [`results/original_paper/README.md`](../results/original_paper/README.md) — why no original data file exists
- [`results/reconstruction_v2/README.md`](../results/reconstruction_v2/README.md) — what the reconstruction produced
- [`MT_Reconstruction_Audit.md`](MT_Reconstruction_Audit.md) — full MT audit
- [`REPRODUCIBILITY.md`](REPRODUCIBILITY.md) — what is and is not reproducible
