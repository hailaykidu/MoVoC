...
here are therefore generated by the reconstructed implementation pipeline
rather than recovered from the original runs, and are kept in a separate
table from the published results above. Because the original scoring
