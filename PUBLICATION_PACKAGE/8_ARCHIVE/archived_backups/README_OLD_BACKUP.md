...
**Repository Status:** Independent full-scale reconstruction archived as part of the MoVoC project.  
**Evaluation Type:** Extrinsic (Downstream Task - Machine Translation) | **Version:** V2  
**Publication Package:** See [PUBLICATION_PACKAGE/](PUBLICATION_PACKAGE/) for complete Reconstruction V2 results.

⚠️ **IMPORTANT DISCLAIMER:**

This repository contains **independent, full-scale experiments for extrinsic evaluation (machine translation)** and should **NOT** be interpreted as:
- Direct reproduction of Table 3 from the official published paper (which uses intrinsic evaluation)
- Official MoVoC project publication materials
- Peer-reviewed publication

See [REPOSITORY_CONTEXT.md](REPOSITORY_CONTEXT.md) for full disclaimers, context, and proper citation guidelines. This is a research archive providing **extended validation through extrinsic evaluation**, distinct from the original publication's intrinsic evaluation approach.

## 🎯 Overview

This repository contains the complete experimental framework, code, models, and results for comparing three tokenization strategies (BPE, WordPiece, and MoVoC-Tok) for machine translation to low-resource African languages using **independent full-scale fine-tuning** with **rigorous multi-seed validation**.
