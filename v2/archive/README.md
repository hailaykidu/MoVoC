# Archive — historical and exploratory material

Retained for transparency, **not part of the primary repository presentation**.
Nothing here is required to reproduce Table 2, Table 3 or Table 4, and nothing
here is cited as a result.

Classified as exploratory/historical in
[`../../docs/contribution_material_review.md`](../../docs/contribution_material_review.md).
...
kept deliberately as a debugging record. They must never be read as
measurements.

Current results live in `v2/table2/`, `v2/table3/` and `v2/table4/`.
