...
Both Table~\ref{tab:datasets} and Table~\ref{tab:intrinsic} report values well
below the originally published record's exact figures (precision 74.6--88.3
there against 0.3005--0.5629 here, over a different evaluation set). Neither
table reproduces those numbers, nor is intended to. MoVoC-Tok wins on
